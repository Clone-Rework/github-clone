...
export const RepoNav = () => {
	return (
		<ul className='border-b border-gray-400 flex items-center px-8 mt-4'>
			<li className='font-semibold'>
				<a href='#' className='flex items-center border-b-2 border-red-500 px-4 pb-3'>
					<svg className='w-4 fill-current' viewBox='0 0 16 16' aria-hidden='true'>
						<path
							fill-rule='evenodd'
			...
			<li className='font-semibold'>
				<a
					href='#'
					className='flex items-center border-b-2 border-transparent px-4 pb-3 hover:border-gray-400 transition ease-in-out duration-300'
				>
					<svg className='w-4 fill-current' viewBox='0 0 16 16' aria-hidden='true'>
						<path
							fill-rule='evenodd'
					...
					<div className='text-xs rounded-full bg-gray-300 px-2 ml-1'>14</div>
				</a>
			</li>
			<li className='font-semibold'>
				<a
				...
				>
					...
					<div className='text-xs rounded-full bg-gray-300 px-2 ml-1'>23</div>
				</a>
			</li>
			<li className='font-semibold'>
				<a
