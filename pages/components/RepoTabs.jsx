...
export const RepoTabs = () => {
	return (
		<div className='flex items-center justify-between px-8 py-4'>
			<div className='flex'>
				<svg className='w-4 fill-current text-gray-600 mt-1' viewBox='0 0 16 16' aria-hidden='true'>
					<path
						fill-rule='evenodd'
				...
				<div className='flex items-center text-xl ml-2'>
					...
					<span className='ml-1 font-semibold text-gray-700'>/</span>
					<a href='#' className='text-blue-700 hover:underline ml-1 font-semibold'>
						tailwindcss
					</a>
				</div>
			</div>
